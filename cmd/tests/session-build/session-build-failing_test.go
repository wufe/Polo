...
func Test_SessionBuildFailing(t *testing.T) {
	...
	events_assertions.AssertSessionEvents(
		sessionChan,
		[]models.SessionBuildEventType{
			models.SessionBuildEventTypeBuildStarted,
			models.SessionBuildEventTypePreparingFolders,
			models.SessionBuildEventTypeCommandsExecutionStarted,
			models.SessionBuildEventTypeCommandsExecutionFailed,
		},
		t,
		10*time.Second,
	)
