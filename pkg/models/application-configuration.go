...
func NewApplicationConfiguration(configuration *ApplicationConfiguration, environment utils.Environment) (*ApplicationConfiguration, error) {
	configuration.RWLocker = utils.GetMutex(environment)
